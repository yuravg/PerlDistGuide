...
- [[#examples][Examples]]
  ...
  - [[#example5-helloworld5][Example5, 'Hello::World5']]
:END:
...
├── dist.ini
├── bin/
│   └── example-hello5     # The executable script
├── lib/
...
└── t/
    ├── 00-basic.t         # Test classes
    └── hello5.t           # Test script
#+end_src

*** Add README

Edit [[Example-Hello5/README.md]] file:

#+begin_src markdown :tangle Example-Hello5/README.md :mkdirp yes
# Example::Hello5
...
Edit [[Example-Hello5/dist.ini]] file:

#+begin_src conf-windows :tangle Example-Hello5/dist.ini :mkdirp yes
name    = Example-Hello5
author  = Your Name <email@example.com>
license = Perl_5
copyright_holder = Your Name
...
Edit [[Example-Hello5/bin/example-hello5]] file:

#+begin_src cperl :tangle Example-Hello5/bin/example-hello5 :mkdirp yes
#!/usr/bin/env perl
...
exit Example::CLI->new()->run(@ARGV);
#+end_src

#+begin_src shell-script
# Add execute permission:
sudo chmod +x bin/example-hello5
#+end_src

*** Add module

Edit [[Example-Hello5/lib/Example/CLI.pm]] file:

#+begin_src cperl :tangle Example-Hello5/lib/Example/CLI.pm :mkdirp yes
package Example::CLI;
...
Edit [[Example-Hello5/lib/Example/Handler/Bye.pm]] file:

#+begin_src cperl :tangle Example-Hello5/lib/Example/Handler/Bye.pm :mkdirp yes
...
Edit [[Example-Hello5/lib/Example/Handler/Hello.pm]] file:

#+begin_src cperl :tangle Example-Hello5/lib/Example/Handler/Hello.pm :mkdirp yes
...
Edit [[Example-Hello5/lib/Example/Handler/HowAreYou.pm]] file:

#+begin_src cperl :tangle Example-Hello5/lib/Example/Handler/HowAreYou.pm :mkdirp yes
...
Edit [[Example-Hello5/t/00-basic.t]] file:

#+begin_src cperl :tangle Example-Hello5/t/00-basic.t :mkdirp yes
use Test::More;
use Example::Handler::Hello;
use Example::Handler::Bye;
use Example::Handler::HowAreYou;
...
[[Example-Hello5/t/hello5.t]]

#+begin_src cperl :tangle Example-Hello5/t/hello5.t :mkdirp yes
use Test::More;
use Test::Output;
...
Edit [[Example-Hello5/Makefile.PL]] file:

#+begin_src cperl :tangle Example-Hello5/Makefile.PL :mkdirp yes
use ExtUtils::MakeMaker qw(WriteMakefile);
