...
Edit [[Example3-Hello/README.md]] file:
...
Edit [[Example3-Hello/dist.ini]] file:
...
Edit [[Example3-Hello/bin/example3-hello]] file:
...
Edit [[Example3-Hello/lib/Example3.pm]] file:
...
Edit [[Example3-Hello/lib/Example3/Bye.pm]] file:
...
Edit [[Example3-Hello/lib/Example3/Hello.pm]] file:
...
Edit [[Example3-Hello/lib/Example3/HowAreYou.pm]] file:
...
Edit [[Example3-Hello/t/00-basic.t]] file:
...
Edit [[Example3-Hello/Makefile]] file:
...
Edit [[Example4-Hello/README.md]] file:
...
Edit [[Example4-Hello/dist.ini]] file:
...
Edit [[Example4-Hello/bin/example4-hello]] file:
...
Edit [[Example4-Hello/lib/Example4.pm]] file:
...
Edit [[Example4-Hello/lib/Example4/Bye.pm]] file:
...
Edit [[Example4-Hello/lib/Example4/Hello.pm]] file:
...
Edit [[Example4-Hello/lib/Example4/HowAreYou.pm]] file:
...
Edit [[Example4-Hello/t/00-basic.t]] file:
...
Edit [[Example4-Hello/Makefile.PL]] file:
...
Edit [[Example5-Hello/README.md]] file:
...
Edit [[Example5-Hello/dist.ini]] file:
...
Edit [[Example5-Hello/bin/example5-hello]] file:
...
Edit [[Example5-Hello/lib/Example5/CLI.pm]] file:
...
Edit [[Example5-Hello/lib/Example5/Handler/Bye.pm]] file:
...
Edit [[Example5-Hello/lib/Example5/Handler/Hello.pm]] file:
...
Edit [[Example5-Hello/lib/Example5/Handler/HowAreYou.pm]] file:
...
Edit [[Example5-Hello/t/00-basic.t]] file:
...
Edit [[Example5-Hello/Makefile.PL]] file:
